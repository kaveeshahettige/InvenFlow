    ...
    <form action="{{route('items.store')}}" method="post">
        ...
        <div class="space-y-12 mx-auto max-w-xl px-6 lg:px-8 mt-10">
            <div class="border-b border-gray-900/10 pb-12">
                <p class="text-base/7 font-semibold text-3xl text-gray-900">Add New Item</p>
              ...
              @enderror
                ...
                <div>
                    <button type="submit" class="mt-5 flex w-full justify-center rounded-md bg-gray-800 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add Item</button>
                  </div>
